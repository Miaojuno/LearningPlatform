    ...
    $(document).on("click", "#roleModifyApplyBtn", function () {
        layui.use('layer', function () {
            ...
            layer.open({
                ...
                btn: ['确定', '关闭'],
                yes: function (index) {
                    if($("#role-modify-apply-select").val()==null || $("#role-modify-apply-select").val().trim()==""){
    ...
    $(document).on("click", "#supeiorModifyApplyBtn", function () {
        layui.use('layer', function () {
            ...
            layer.open({
                ...
                btn: ['确定', '关闭'],
                yes: function (index) {
                    if($("#superior-modify-apply-div .newId").val().trim()==null || $("#superior-modify-apply-div .newId").val().trim()==""){
